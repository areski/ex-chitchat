defmodule ChitChatWeb.Helpers.CheckboxHelper do
  use Phoenix.HTML
  ...
  ## Example
      ...
      <div class="checkbox">
        <label>
          <input name="post[tags][]" id="post_tags_1" type="checkbox" value="1" checked>
          <input name="post[tags][]" id="post_tags_2" type="checkbox" value="2">
        </label>
      </div
  """
