defmodule ChitChat.CustomURLField do
  use Ecto.Type
  def type, do: :string
  ...
  def cast(data), do: IO.inspect("data: #{inspect(data)}")
  ...
  def render_form(_conn, changeset, form, field, _options) do
    [
      ...
      Phoenix.HTML.Form.text_input(form, field,
        placeholder: "Insert the name of the link",
        class: "form-control",
      ...
      Phoenix.HTML.Form.text_input(form, field,
        placeholder: "Insert the URL of the link",
        class: "form-control",
