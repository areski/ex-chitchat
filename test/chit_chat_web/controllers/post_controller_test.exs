defmodule ChitChatWeb.PostControllerTest do
  use ChitChatWeb.ConnCase

  alias ChitChat.Blog

  @create_attrs %{body: "some body", published: true, title: "some title", unique_uuid: "7488a646-e31f-11e4-aace-600308960662", views: 42}
